...
def euclidean_distance(x: Series, y: Series):
    ...
    :param y:
        Vector 2.
    :return:
        The euclidean distance beetween Vector 1 and Vector 2. For more info, see:  https://en.wikipedia.org/wiki/Euclidean_distance
    """
...
def cosine_distance(x: Series, y: Series):
    ...
    :param y:
        Vector 2.
    :return:
        The cosine similarity beetween Vector 1 and Vector 2. For more info, see: https://en.wikipedia.org/wiki/Cosine_similarity
    """
